...
const SortingEmployees = () => {
    ...
    const handleSort=()=>{
        const sortedEmployees = [...employeeData].sort((a, b) => b.salary - a.salary); // sorting the employees in a new array and then seting it to setEmployeeData
  ...
  return (
    ...
    <button onClick={handleSort} className='btn'>sort employees salary wise</button>
    </>
  )
}
